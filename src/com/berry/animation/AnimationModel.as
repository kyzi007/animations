package com.berry.animation {
    ...
    public class AnimationModel extends SimpleEventDispatcher implements IReusable {
        ...
        public function set complex (value:Boolean):void {
            _complex = value;
        }
        ...
        private function get isState ():Boolean {
            return _presetList is Array;
        }

        public function get isSubStates ():Boolean {
            return _presetList ? _presetList[_state] && _presetList[_state] is Array : -1;
        }
        ...
        public function set shotName (value:String):void {
            _shotName = value;
        }
        ...
        public function get subState ():int {
            return _subState;
        }
        ...
        public function get totalFrame ():uint {
            return _currentPreset().totalFrames;
        }
    }
}
