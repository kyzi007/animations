package com.berry.animation {
    ...
    import com.berry.animation.event.AssetViewEvents;
    import com.berry.animation.graphic.AnimationsList;
    import com.berry.animation.graphic.AssetMovieClip;
    import com.berry.animation.graphic.AssetViewStateEnum;
    ...
    import com.berry.animation.library.SWFLibraryTemp;
    import com.berry.animation.logic.Generator;
    ...
    public class BaseAssetView extends AssetMovieClip {
        ...
        public function nextToTime ():void {
            CONFIG::debug{
                KLog.log("AssetView : nextToTime  " + _assetName, KLog.DEBUG);
            }
            stop();
            //next();
        }
        ...
        override protected function finishAnimation ():void {
            ...
            CONFIG::debug{
                KLog.log("AssetView : finishAnimation  " + _assetName, KLog.DEBUG);
            }
            next();
        }
            ...
            switch (_state.value) {
                ...
                case AssetViewStateEnum.STATE_PLAY:
                    ...
                    if (!_animationQuery._currentPreset()) {
                        CONFIG::debug{
                            KLog.log("AssetView : setMovieState  " + 'invalid animation ' + _assetName + ' ' + _animationQuery.fullPartAnimationName, KLog.CRITICAL);
                        }
                        return;
                    }
                    ...
                    if (!_nextAssetData.isRenderFinish) {
                        ...
                        CONFIG::debug{
                            KLog.log("AssetView : setMovieState  " + _assetName + " " + _animationQuery.fullPartAnimationName + " " + timeToNext + "  " + _loopCount, KLog.DEBUG);
                        }
                    }
                    break;
        ...
        public function get animationStep ():uint {
